...
app = FastAPI(title="Layout Agent")
...
DEFAULT_LAYOUT = {
  ...
  "nodes": {
    "img_1778485681535_4": {
      ...
      "nh": 1, "nw": 1, "nx": -0.0022964812058295027, "ny": 0,
    ...
    "img_1778486846247_10": {
      ...
      "nh": 0.037741738009449737, "nw": 0.034185517608088176, "nx": 0.30870529955458104, "ny": 0.11568735928850149,
    ...
    "img_1778486856821_11": {
      ...
      "nh": 0.03774173800944972, "nw": 0.034185517608088176, "nx": 0.21274223486351124, "ny": 0.11731653080665036,
    ...
    "img_1778487081392_12": {
      ...
      "nh": 0.03503770188284304, "nw": 0.03418551760808818, "nx": 0.2627754363955789, "ny": 0.1183913954151082,
    ...
    "img_1778487101466_13": {
      ...
      "nh": 0.03233366575623633, "nw": 0.039593589861301584, "nx": 0.4005187425757899, "ny": 0.11731653080665036,
    ...
    "img_1778487110538_14": {
      ...
      "nh": 0.03233366575623633, "nw": 0.03688955373469488, "nx": 0.35235494360579267, "ny": 0.1183913954151082,
    ...
    "img_1778489515746_17": {
      ...
      "nh": 0.3152992662905912, "nw": 0.7637522830873364, "nx": 0.08316884733323088, "ny": 0.5294798673226928,
    ...
    "text_1778486004640_6": {
      ...
      "nh": 0.06804963433919406, "nw": 0.45466173716839364, "nx": 0.3203899861054117, "ny": 0.8860919250351568,
      ...
      "width": 491.03467614186513, "height": 73.49360508632958, "parentId": "artboard_1778485662755_3",
      "fontSizeRatio": 0.044444444444444446
    },
    "text_1778486136643_7": {
      "x": 194.38702539993648, "y": 350.16045634860865,
      "id": "text_1778486136643_7",
      "nh": 0.037037037037037035, "nw": 0.7120318482825286, "nx": 0.17998798648142267, "ny": 0.32422264476723023,
      "data": {"content": "Comfort that defines modern living."},
      "name": "Text", "type": "text",
      "style": {"layout": {}, "visual": {"fill": {"type": "none"}, "color": {"type": "solid", "value": "#FFFF"}, "fontSize": 48, "fontFamily": "Arial", "fontWeight": 600}},
      "width": 768.994396145131, "height": 40, "parentId": "artboard_1778485662755_3",
      "fontSizeRatio": 0.044444444444444446
    },
    "text_1778486306230_8": {
      "x": 133.38976610032938, "y": 175.51991211747026,
      "id": "text_1778486306230_8",
      "nh": 0.3503396592170152, "nw": 0.7815649104172034, "nx": 0.12350904268549016, "ny": 0.1625184371458058,
      ...
      "width": 844.0901032505798, "height": 378.36683195437644, "parentId": "artboard_1778485662755_3",
      "fontSizeRatio": 0.06666666666666667
    },
    "text_1778486552508_9": {
      "x": 482.7000303705086, "y": 121.09848637690123,
      "id": "text_1778486552508_9",
      "nh": 0.04541430724262293, "nw": 0.43652086535182927, "nx": 0.44694447256528574, "ny": 0.1121282281267604,
      ...
      "width": 471.4425345799756, "height": 49.04745182203276, "parentId": "artboard_1778485662755_3",
      "fontSizeRatio": 0.037037037037037035
    },
    "text_1778489078397_16": {
      "x": 130.87523314340268, "y": 448.5125264397059,
      "id": "text_1778489078397_16",
      "nh": 0.13998918694820744, "nw": 0.16302282390535613, "nx": 0.12118077142907656, "ny": 0.415289376333061,
      "data": {"content": "20%\nOFF"},
      "name": "Text", "type": "text",
      "style": {"layout": {}, "visual": {"fill": {"type": "none"}, "color": {"type": "solid", "value": "#FFFF"}, "fontSize": 56, "fontFamily": "Arial", "fontWeight": 700}},
      "width": 176.0646498177846, "height": 151.18832190406403, "parentId": "artboard_1778485662755_3",
    ...
    "circle_1778488914968_15": {
      ...
      "nh": 0.14248292500533227, "nw": 0.14789099725854568, "nx": 0.09601711880487064, "ny": 0.4050170159100531,
...
@app.get("/api/layout/{session_id}")
async def get_layout(session_id: str):
    session = get_session(session_id)
    return {"layout": session["layout"]}

@app.post("/api/reset/{session_id}")
async def reset_layout(session_id: str):
    sessions[session_id] = {
        "layout": copy.deepcopy(DEFAULT_LAYOUT),
        "history": []
    }
    return {"layout": sessions[session_id]["layout"]}
...
async def chat(req: ChatRequest):
    ...
    async def event_stream():
        for event in run_agent(req.message, session["layout"], session["history"]):
            if event["type"] in ["tool_call", "error"]:
                yield f"data: {json.dumps(event)}\n\n"
            elif event["type"] == "done":
                session["layout"] = event["layout"]
